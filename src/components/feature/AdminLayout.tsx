...
const adminNavGroups = [
  {
    ...
    items: [
      ...
      { path: "/admin/stats", icon: "ri-bar-chart-line", label: "Th?ng kê h? th?ng", permission: "stats.view" as Permission },
      { path: "/admin/learn-stats", icon: "ri-graduation-cap-line", label: "Th?ng kê h?c t?p", permission: "stats.view" as Permission },
    ],
  },
  {
    label: "Ngu?i dùng",
    color: "#34d399",
    items: [
      { path: "/admin/users", icon: "ri-user-settings-line", label: "Qu?n lý thành viên", permission: "users.view" as Permission },
      { path: "/admin/roles", icon: "ri-shield-keyhole-line", label: "Phân quy?n Admin", permission: "system.roles" as Permission },
      { path: "/admin/coupon", icon: "ri-coupon-3-line", label: "Coupon & Mã gi?m giá", permission: "users.vip" as Permission },
    ],
  },
  {
    label: "N?i dung h?c",
    ...
    items: [
      ...
      { path: "/admin/community-settings", icon: "ri-team-line", label: "C?u hình c?ng d?ng", permission: "content.view" as Permission },
      { path: "/admin/content-learn", icon: "ri-book-open-line", label: "Qu?n lý n?i dung h?c", permission: "eps.edit" as Permission },
      { path: "/admin/series", icon: "ri-stack-line", label: "Series & Ebook", permission: "eps.edit" as Permission },
      { path: "/admin/eps", icon: "ri-image-edit-line", label: "Qu?n lý EPS", permission: "eps.edit" as Permission },
      { path: "/admin/eps-new", icon: "ri-add-circle-line", label: "Thêm bài EPS m?i", permission: "eps.edit" as Permission },
  ...
  },
  {
    ...
    color: "#f87171",
    items: [
      { path: "/admin/bugs", icon: "ri-bug-line", label: "Báo cáo l?i & Vi ph?m", permission: "reports.view" as Permission },
      { path: "/admin/feedback", icon: "ri-chat-smile-2-line", label: "Góp ý & Ðánh giá", permission: "reports.view" as Permission },
  ...
  },
  {
    ...
    items: [
      { path: "/admin/control", icon: "ri-settings-4-line", label: "Cài d?t admin", permission: "system.settings" as Permission },
      { path: "/admin/xp-config", icon: "ri-scales-3-line", label: "C?u hình XP & Anti-cheat", permission: "system.settings" as Permission },
      { path: "/admin/pricing", icon: "ri-vip-crown-line", label: "Gói VIP & Giá", permission: "system.settings" as Permission },
      { path: "/admin/settings", icon: "ri-settings-3-line", label: "Cài d?t API & Keys", permission: "system.settings" as Permission },
      { path: "/admin/seo", icon: "ri-search-eye-line", label: "Cài d?t SEO", permission: "system.settings" as Permission },
  ...
  return (
    <div className="px-2 pb-2">
      ...
      <div className="space-y-0.5">
        ...
        {results.length === 0 && (
          <p className="text-center py-4 text-xs" style={{ color: "var(--admin-text-faint)" }}>Không tìm th?y</p>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div>
      ...
      >
        ...
        <span className="flex-1 text-left">Tìm tác v? nhanh...</span>
          ...
          >
            ...
            {!sidebarCollapsed && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[9px]" style={{ color: "var(--admin-text-faint)" }}>Hàn Qu?c Oi!</p>
              </div>
            )}
            <button
