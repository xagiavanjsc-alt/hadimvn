    ...
    <div className="px-3 py-2.5 bg-app-accent-primary/5 border border-app-accent-primary/10 rounded-xl mb-2 space-y-2">
      <div className="flex items-center gap-1.5">
        ...
        <div className="flex-1">
          <p className="text-app-accent-primary text-xs font-bold">{streak.count} ngày liên ti?p</p>
        </div>
      </div>
      <div className="flex items-center gap-1.5">
...
const navGroups = [
  ...
  },
  {
    ...
    color: "app-accent-primary",
    items: [
      { path: "/hanja-tree", icon: "ri-git-merge-line", label: "Hình cây t? v?ng" },
      ...
      { path: "/advanced-dictionary", icon: "ri-search-2-line", label: "Tra c?u Hán Hàn" },
    ],
  },
  {
    label: "Ai & K? nang",
    ...
    items: [
      ...
      { path: "/ai-pronunciation", icon: "ri-mic-line", label: "Phát âm & Giao ti?p" },
  ...
  },
  {
    ...
    color: "#fb923c",
    items: [
      { path: "/community", icon: "ri-group-line", label: "H?i dáp" },
      { path: "/profile", icon: "ri-user-3-line", label: "H? so cá nhân" },
    ],
  },
];
...
function PinnedSection({ pinnedPaths, onUnpin, onNavigate, currentPath }: {
  ...
  return (
    <div className="mb-2">
      <p className="text-[9px] tracking-normal font-semibold text-app-accent-primary/40 px-3 py-1">Ðã ghim</p>
    ...
    <aside className="w-60 min-h-screen bg-[#141720] flex flex-col border-r border-app-border overflow-y-auto">
      ...
      >
        <img
          ...
          alt="Hàn Qu?c Oi! Logo"
          className="w-9 h-9 rounded-lg object-cover"
        />
        <div>
          <p className="text-white font-semibold text-sm leading-tight">Hàn Qu?c Oi!</p>
          <p className="text-app-text-secondary text-xs">H?c ti?ng Hàn</p>
        </div>
      </button>
      ...
      <nav className="flex-1 px-3 py-3 space-y-1">
        ...
        >
          ...
          <span className="flex-1">H?c t? m?i hôm nay</span>
        </button>
        ...
        >
          ...
          <span className="flex-1">Th?ng kê h?c t?p</span>
        </button>

        {/* VIP History shortcut — ch? hi?n khi là VIP */}
        ...
        >
          ...
          <span className="flex-1">Góp ý &amp; Ðánh giá</span>
        </button>
        ...
        >
          ...
          <span className="flex-1">L? trình h?c</span>
        </button>
                    ...
                    return (
                      <div key={item.path} className="flex items-center group/item">
                        ...
                        <button
                          ...
                          title={isPinned ? "B? ghim" : "Ghim vào d?u"}
                        >
        ...
        {/* Admin Panel shortcut — ch? hi?n khi là admin */}
        {user && isAdminDetected && (
          ...
          >
            ...
            <span className="text-xs font-semibold text-rose-400 flex-1 text-left">Trang qu?n lý admin</span>
          ...
          <div>
            ...
            >
              ...
              <div className="text-left flex-1 min-w-0">
                <p className="text-white/70 text-xs font-medium truncate">{profile?.display_name || "H?c viên"}</p>
                <div className="flex items-center gap-1">
                  <div className={`w-1.5 h-1.5 rounded-full ${syncing ? "bg-app-accent-primary animate-pulse" : "bg-emerald-400"}`}></div>
                  <p className="text-app-text-muted text-[10px]">{syncing ? "Ðang sync..." : "Ðã d?ng b?"}</p>
                </div>
              </div>
            </button>
            <button
          ...
          >
            ...
            {pinnedPaths.length > 0 && (
              <div className="p-2 border-t border-app-border">
                ...
                >
                  Xóa t?t c? ghim ({pinnedPaths.length})
                </button>
              </div>
            )}
          </div>
