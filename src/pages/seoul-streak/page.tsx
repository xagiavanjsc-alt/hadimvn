...
export default function SeoulStreakPage() {
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Theo dõi chu?i ngày h?c liên ti?p và nh?n XP bonus"
      actions={
        <button
    ...
    >
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-[#f97316]/15 to-[#f97316]/5 border border-[#f97316]/20 rounded-2xl p-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-baseline gap-2 mb-1">
                ...
                <span className="text-[#f97316] font-semibold text-lg">ngày liên ti?p</span>
              </div>
              <p className="text-white/50 text-sm">
                {isActiveToday
                  ? "Hôm nay dã h?c r?i! Ti?p t?c duy trì nhé."
                  : isStreakAlive
                  ? "Hôm nay chua h?c. Ð?ng d? streak b? gián do?n!"
                  : streak.count === 0
                  ? "B?t d?u streak c?a b?n ngay hôm nay!"
                  : "Streak dã b? gián do?n. B?t d?u l?i nào!"}
              </p>
              {!isActiveToday && (
                <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-5">
            ...
            <div className="bg-app-card/50 rounded-xl p-3 text-center">
              ...
              <p className="text-app-text-secondary text-xs mt-0.5">Streak dài nh?t</p>
            </div>
            <div className="bg-app-card/50 rounded-xl p-3 text-center">
              <p className="text-app-accent-success text-xl font-bold">{streak.totalDays || 0}</p>
              <p className="text-app-text-secondary text-xs mt-0.5">T?ng ngày h?c</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-app-surface/50 border border-app-border rounded-2xl p-5">
          <h3 className="text-white font-semibold text-sm mb-4">Tu?n này</h3>
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1">
                ...
                <p className="text-app-text-muted text-xs mt-1.5">
                  Còn {nextMilestone.days - streak.count} ngày n?a d? nh?n {nextMilestone.bonus} XP bonus
                </p>
              </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className={`text-sm font-semibold ${achieved ? "text-white" : "text-app-text-secondary"}`}>
                      {milestone.label} liên ti?p
                    </p>
                    <p className="text-app-text-muted text-xs">{milestone.days} ngày h?c Seoul</p>
                  </div>
        ...
        <div className="bg-app-surface/50 border border-app-border rounded-2xl p-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-white/50 text-xs">Bài dã h?c</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
            ...
            >
              ...
              <span className="text-white/50 text-xs text-center">H?c bài m?i</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-white/50 text-xs text-center">Ôn t? sai</span>
            </button>
          </div>
        </div>
        ...
        <div className="bg-[#f97316]/5 border border-[#f97316]/15 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white/70 text-xs font-semibold mb-1">M?o duy trì streak</p>
              <p className="text-app-text-secondary text-xs leading-relaxed">
                H?c ít nh?t 1 bài m?i ngày d? duy trì streak. Làm quiz bài h?c s? t? d?ng c?p nh?t streak và ti?n d?. Streak càng dài, XP bonus càng nhi?u!
              </p>
            </div>
          </div>
        </div>
