  ...
  return (
    <DashboardLayout title="Thẻ ghi nhớ" subtitle="Chọn bộ thẻ để bắt đầu học">
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {recentDeckData && (
          <div className="mb-8">
            <p className="text-white/30 text-xs uppercase tracking-widest font-semibold mb-3">Tiếp tục học</p>
            <button
        ...
        {/* All decks */}
        <div>
          <p className="text-white/30 text-xs uppercase tracking-widest font-semibold mb-4">Tất cả bộ thẻ</p>
