        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-5">
              <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mb-4">Xem trước thẻ</p>
            ...
            <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-4">
              <div className="flex items-center justify-between mb-3">
                <p className="text-white/50 text-xs font-semibold uppercase tracking-wider">Caption chia sẻ</p>
                <button
          ...
          <div className="space-y-4">
            {/* Theme selector */}
            <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-5">
              <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mb-3">Chủ đề màu sắc</p>
            ...
            {/* Layout selector */}
            <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-5">
              <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mb-3">Kích thước thẻ</p>
            ...
            {/* Stats summary */}
            <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-5">
              <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mb-3">Thống kê của bạn</p>
              <div className="grid grid-cols-2 gap-2">
                {[
