          ...
          <div className="flex gap-5">
            ...
            <div className="w-52 flex-shrink-0 space-y-4">
              ...
              <div className="bg-white/3 border border-white/8 rounded-xl p-4">
                <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mb-3">Cấp độ</p>
              ...
              {/* Lesson filter */}
              <div className="bg-white/3 border border-white/8 rounded-xl p-4">
                <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mb-3">Bài học</p>
                        ...
                        <div className="px-4 pb-4 border-t border-white/5 pt-3">
                          ...
                          {g.examples.length > 0 && (
                            <div className="space-y-2">
                              <p className="text-white/40 text-xs font-semibold uppercase tracking-wider">Ví dụ</p>
                              {g.examples.map((ex, i) => (
