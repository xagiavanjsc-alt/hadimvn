              ...
              {costSummary.totalCalls === 0 ? (
                ...
                <>
                  ...
                  {Object.keys(costSummary.byModel).length > 0 && (
                    <div>
                      <p className="text-white/40 text-xs font-medium uppercase tracking-wider mb-3">Theo model</p>
                  ...
                  {Object.keys(costSummary.byType).length > 0 && (
                    <div>
                      <p className="text-white/40 text-xs font-medium uppercase tracking-wider mb-3">Theo tính năng</p>
