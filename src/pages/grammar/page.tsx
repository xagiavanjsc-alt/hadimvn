      ...
      {hasSuggestions ? (
        <div className="space-y-3">
          {suggestions.needReview.length > 0 && (
            <div>
              <p className="text-red-400/70 text-[10px] uppercase tracking-widest mb-2 flex items-center gap-1.5">
          ...
          {suggestions.inProgress.length > 0 && (
            <div>
              <p className="text-[#e8c84a]/70 text-[10px] uppercase tracking-widest mb-2 flex items-center gap-1.5">
          ...
          {suggestions.notStarted.length > 0 && (
            <div>
              <p className="text-white/30 text-[10px] uppercase tracking-widest mb-2 flex items-center gap-1.5">
    ...
    <div className={`bg-[#0f1117] border rounded-2xl overflow-hidden transition-all ${isExpanded ? "border-white/12" : "border-white/5"}`}>
      ...
      {isExpanded && (
        <div className="px-5 pb-5 border-t border-white/5 pt-4">
          ...
          {/* Examples */}
          <div className="mb-5">
            <p className="text-white/30 text-[10px] uppercase tracking-widest mb-2">Ví dụ</p>
          ...
          {/* Exercises */}
          <div>
            <p className="text-white/30 text-[10px] uppercase tracking-widest mb-3">Bài tập luyện tập</p>
            <div className="space-y-3">
  ...
  return (
    <div className="absolute top-full left-0 right-0 mt-1.5 bg-[#1a1d27] border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden max-h-80 overflow-y-auto">
      <div className="px-3 py-2 border-b border-white/5">
        <p className="text-white/30 text-[10px] uppercase tracking-wider">{suggestions.length} mẫu câu phù hợp</p>
      </div>
      {suggestions.map(p => {
