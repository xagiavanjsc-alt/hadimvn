          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-app-text-secondary text-sm">Roadmap 60 bài h?c tr?c quan</p>
              </div>
            </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: "Ði?m TB", value: stats.avgScore > 0 ? `${Math.round(stats.avgScore)}%` : "—", sub: "Trung bình", icon: "ri-bar-chart-line", color: "app-accent-primary" },
                              ...
                              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-50 w-48 bg-[#1a1d2e] border border-app-border rounded-lg p-2.5 shadow-xl pointer-events-none">
                                ...
                                <div className="flex items-center gap-1.5 mb-1.5">
                                  ...
                                  <span className="text-[10px]" style={{ color: statusColor }}>
                                    {status === "completed" ? "Ðã hoàn thành" : status === "in_progress" ? "Ðang h?c" : "Chua h?c"}
                                  </span>
                                </div>
                                {progress?.score > 0 && (
                                  <p className="text-app-text-secondary text-[10px] mb-1.5">Ði?m: {Math.round(progress.score)}%</p>
                                )}
          ...
          <div className="bg-app-surface/50 border border-app-border rounded-xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-white font-semibold text-sm">Th?ng kê t? v?ng theo bài</h3>
                ...
                return (
                  <>
                    <div className="bg-emerald-500/8 border border-emerald-500/15 rounded-lg p-3 text-center">
                      ...
                      <p className="text-app-accent-success/60 text-[10px] mt-0.5">Ðã hoàn thành</p>
                    </div>
                    <div className="bg-app-accent-primary/8 border border-app-accent-primary/15 rounded-lg p-3 text-center">
                      ...
                      <p className="text-app-accent-primary/60 text-[10px] mt-0.5">Ðã ti?p xúc</p>
                    </div>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2 border-t border-app-border">
            ...
            {[
              { color: "#34d399", label: "Ðã hoàn thành" },
              { color: "#f59e0b", label: "Ðang h?c" },
