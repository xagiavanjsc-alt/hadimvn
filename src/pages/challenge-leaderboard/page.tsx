...
export default function ChallengeLeaderboardPage() {
  ...
  const leaderboard = useMemo<LeaderboardEntry[]>(() => {
    ...
    const badge = myStats.wins >= 10 ? "Cao th?" : myStats.wins >= 5 ? "Gi?i" : myStats.wins >= 1 ? "Khá" : "M?i b?t d?u";
  ...
  return (
    <DashboardLayout
      title="B?ng x?p h?ng thách d?u"
      subtitle="Top ngu?i th?ng nhi?u nh?t — c?nh tranh và leo h?ng m?i tu?n"
    >
      {/* Period selector */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-app-bg border border-app-border rounded-2xl p-6">
            <p className="text-app-text-secondary text-xs font-semibold tracking-normal mb-5">Top 3 tu?n này</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-app-bg border border-app-accent-primary/15 rounded-2xl p-5">
            <p className="text-white font-semibold text-sm mb-4">Th?ng kê c?a b?n</p>
            {myEntry && (
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-app-text-secondary text-xs">Th?ng / Thua / Hòa</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-app-text-secondary text-xs">XP t? thách d?u</span>
          ...
          <div className="bg-app-bg border border-app-border rounded-2xl p-5">
            <p className="text-white font-semibold text-sm mb-3">Mùa gi?i hi?n t?i</p>
            <div className="space-y-2 text-xs">
              ...
              <div className="flex justify-between">
                <span className="text-app-text-secondary">K?t thúc</span>
          ...
          <div className="bg-app-accent-primary/5 border border-app-accent-primary/15 rounded-xl p-4">
            <p className="text-app-accent-primary text-xs font-semibold mb-2">Cách tính di?m</p>
            <div className="space-y-1.5 text-[10px] text-white/35 leading-relaxed">
              ...
              <p><i className="ri-scales-3-line text-app-text-muted mr-1"></i>Hòa: +1 di?m x?p h?ng</p>
