...
const DEFAULT_MESSAGES = [
  `🇰🇷 Chào bạn! Hôm nay bạn chưa học tiếng Hàn đúng không? Chỉ 10 phút thôi là đủ để giữ streak rồi! Vào ${SITE_HOST} học ngay nhé! 🔥`,
  `📚 Nhắc nhở học tập: Bạn đang có streak tốt đấy! Đừng để gián đoạn nhé. Vào học 1 bài EPS hoặc 10 từ vựng ngay nào! ${SITE_HOST}`,
