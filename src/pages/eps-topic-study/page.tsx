  ...
  if (finished) {
    ...
    return (
      <div className="text-center py-16 max-w-md mx-auto">
        ...
        <p className="text-white/50 text-sm mb-6">
          {score}/{questions.length} câu dúng
        </p>
        <button
...
// -- Listen Mode (Nghe phát âm + di?n t?) ----------------------------------
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      ...
      <div className="bg-app-card/50 border border-app-border rounded-2xl p-8 text-center space-y-4">
        <p className="text-app-text-secondary text-xs">Nghe và di?n t? ti?ng Hàn</p>
        ...
        <p className="text-app-text-muted text-xs">Nh?n d? nghe phát âm</p>
        ...
        <div className="border-t border-app-border pt-3">
          {showHint ? (
            ...
            >
              <i className="ri-eye-line mr-1"></i>Xem g?i ý nghia
            </button>
          )}
        </div>
      </div>
      ...
      <div className="space-y-3">
        <input
          ...
          disabled={submitted}
          placeholder="Ði?n t? ti?ng Hàn b?n nghe du?c..."
...
// -- Fill Mode (Xem nghia + di?n t? ti?ng Hàn) -----------------------------
...
export default function EpsTopicStudyPage() {
  ...
  const MODES = [
    { id: "browse" as const, icon: "ri-list-check-2", label: "Duy?t t? v?ng", desc: "Xem và tìm ki?m t?" },
    ...
    { id: "listen" as const, icon: "ri-headphone-line", label: "Nghe & Ði?n", desc: "Nghe phát âm r?i di?n" },
    { id: "fill" as const, icon: "ri-edit-line", label: "Ði?n t?", desc: "Xem nghia, di?n ti?ng Hàn" },
  ];
      ...
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-app-text-secondary text-sm">L?c và h?c t? v?ng theo nhóm ch? d? EPS</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-app-surface/50 border border-app-border rounded-xl p-4">
                <p className="text-white/50 text-xs mb-1">T? v?ng dã ch?n</p>
              ...
              {/* Quick links */}
              <div className="bg-app-surface/50 border border-app-border rounded-xl p-4 space-y-2">
                <p className="text-app-text-secondary text-xs mb-2">H?c thêm</p>
                <button
