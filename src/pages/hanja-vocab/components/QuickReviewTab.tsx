    ...
    <div className="relative flex flex-col items-center select-none">
      ...
      <div className="flex justify-between w-full max-w-sm mb-3 px-2">
        ...
        <div className="flex items-center gap-1 text-sm font-semibold text-green-500" style={{ opacity: knowOpacity }}>
          Ðã bi?t<i className="ri-checkbox-circle-line text-lg"></i>
        </div>
      </div>
      ...
      {revealed && (
        <div className="flex gap-4 mt-5">
          ...
          >
            Ðã bi?t<i className="ri-check-line text-lg"></i>
          </button>
        </div>
      )}

      <p className="text-xs text-gray-400 mt-3">Kéo sang ph?i = Ðã bi?t · Kéo sang trái = Chua bi?t</p>
    </div>
  );
}
      ...
      <div className="max-w-lg mx-auto">
        <div className="bg-white border border-gray-100 rounded-2xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500">Ôn nhanh — kéo ph?i n?u bi?t, kéo trái n?u chua bi?t</p>
          </div>
          ...
          {/* Group filter */}
          <div className="mb-5">
            <p className="text-xs text-gray-500 mb-2">L?c theo nhóm ch? cái</p>
    ...
    return (
      <div className="max-w-lg mx-auto">
        <div className="bg-white border border-gray-100 rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-500 mb-1">Ðã bi?t {result.known} / {result.total} t?</p>
          <p className="text-sm text-gray-400 mb-2">
            {pct >= 80 ? "Xu?t s?c! B?n nh? r?t t?t!" : pct >= 50 ? "Khá t?t! Ti?p t?c ôn nhé!" : "C?n ôn thêm! Ð?ng n?n lòng!"}
          </p>
          <p className="text-xs text-green-600 mb-6">Các t? b?n bi?t dã du?c dánh d?u &ldquo;Ðã thu?c&rdquo; t? d?ng</p>
