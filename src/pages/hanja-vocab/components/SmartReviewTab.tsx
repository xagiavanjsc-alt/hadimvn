      ...
      <div className="max-w-lg mx-auto">
        <div className="bg-app-surface/50 border border-app-border rounded-2xl p-8 text-center">
          ...
          <div className="flex gap-3">
            <button onClick={() => startSession(sessionCards.length)} className="flex-1 py-3 bg-app-accent-primary text-white rounded-xl font-semibold cursor-pointer hover:bg-app-accent-primary/90 transition-colors">Ôn lại</button>
