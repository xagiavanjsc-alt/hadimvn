      ...
      {result && (
        <div className="bg-[#0f1117] border border-[#e8c84a]/20 rounded-xl overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            {/* Story preview */}
            <div>
              <p className="text-white/40 text-[10px] font-bold uppercase tracking-wider mb-2">Truyện chêm</p>
            ...
            {result.explanation && (
              <div>
                <p className="text-white/40 text-[10px] font-bold uppercase tracking-wider mb-2">Ngữ pháp</p>
