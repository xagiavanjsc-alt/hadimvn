      ...
      const combined: LeaderboardEntry[] = userIds
        .map(uid => {
          ...
          return {
            rank: 0,
            userId: uid,
            displayName: p?.display_name || "H?c viên",
            avatar: p?.avatar_url || "",
            score: d.best,
      ...
      <div className="bg-gradient-to-r from-[#1a1d27] to-[#13151c] border-b border-app-border px-6 py-5">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-white font-bold text-lg">B?ng x?p h?ng toàn c?u EPS</h1>
              <p className="text-app-text-secondary text-xs">Top h?c viên di?m cao nh?t · C?p nh?t real-time</p>
            </div>
          </div>
          ...
          <>
            ...
            <div className="bg-[#1a1d27] border border-app-border rounded-2xl overflow-hidden">
              <div className="px-4 py-3 border-b border-app-border flex items-center justify-between">
                ...
                <span className="text-app-text-muted text-xs">{entries.length} h?c viên</span>
              </div>
            ...
            {!user && (
              <div className="bg-[#1a1d27] border border-app-accent-primary/20 rounded-xl p-5 text-center">
                <p className="text-white font-semibold text-sm mb-1">B?n mu?n xu?t hi?n trên b?ng x?p h?ng?</p>
                <p className="text-app-text-secondary text-xs mb-4">Ðang nh?p và b?t d?u thi EPS d? du?c x?p h?ng toàn c?u!</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                { label: "H?c viên tham gia", value: "10,247", icon: "ri-group-line", color: "app-accent-primary" },
                { label: "Bài thi tu?n này", value: "3,891", icon: "ri-file-list-3-line", color: "#10b981" },
                { label: "Ði?m TB toàn c?u", value: "74.2", icon: "ri-bar-chart-line", color: "#f59e0b" },
              ].map(s => (
