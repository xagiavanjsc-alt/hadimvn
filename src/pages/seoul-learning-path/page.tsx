    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-5 md:mb-6">
      ...
      <div className="bg-app-bg border border-app-border rounded-xl p-3 md:p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-app-text-secondary text-xs">Ðã h?c</span>
        </div>
      ...
      <div className="bg-app-bg border border-app-border rounded-xl p-3 md:p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-app-text-secondary text-xs">Ðang h?c</span>
        </div>
...
export default function SeoulLearningPathPage() {
  ...
  return (
    <DashboardLayout
      title="H?c theo l? trình"
      subtitle="G?i ý bài h?c ti?p theo d?a trên ti?n d? c?a b?n"
      actions={
      ...
      <div className="max-w-3xl mx-auto space-y-5">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <span className="text-[10px] text-app-text-muted flex items-center gap-1">
                    <i className="ri-book-2-line text-xs"></i>{nextStep.lesson.grammarPoints.length} ng? pháp
                  </span>
                  <span className="text-[10px] text-app-text-muted flex items-center gap-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            { icon: "ri-file-list-3-line", color: "#34d399", label: "Thi th? bài", path: "/seoul-lesson-quiz" },
            { icon: "ri-headphone-line", color: "#06b6d4", label: "Nghe & nh?n bi?t", path: "/seoul-listening-quiz" },
            { icon: "ri-error-warning-line", color: "#f87171", label: "Ôn t? sai", path: "/seoul-wrong-review" },
          ].map(a => (
            <button
              key={a.path}
        ...
        <div className="bg-[#a78bfa]/5 border border-[#a78bfa]/15 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white/70 text-xs font-semibold mb-1">M?o h?c theo l? trình</p>
              <ul className="text-app-text-secondary text-xs leading-relaxed space-y-1">
                ...
                <li>• M?i bài h?c kho?ng 30 phút — h?c 1 bài/ngày d? duy trì streak</li>
                <li>• Sau m?i bài, làm quiz d? c?ng c? và nh?n XP</li>
                <li>• Ôn l?i t? sai thu?ng xuyên d? không quên ki?n th?c cu</li>
              </ul>
            </div>
          </div>
        </div>
