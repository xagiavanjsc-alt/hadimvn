    ...
    <div className="relative">
      ...
      {tooltip && tooltip.day.date && (
        ...
        >
          ...
          {tooltip.day.count === 0 ? (
            <p className="text-app-text-muted mt-0.5">Chua h?c ngày này</p>
          ) : (
            <>
...
export default function StudyCalendarPage() {
  ...
  const stats = [
    { icon: "ri-fire-line", label: "Streak hi?n t?i", value: `${streak.count} ngày`, color: "text-orange-400" },
    { icon: "ri-trophy-line", label: "Streak dài nh?t", value: `${longestStreak} ngày`, color: "text-app-accent-primary" },
    { icon: "ri-calendar-check-line", label: "Ngày h?c tháng này", value: `${thisMonthDays} ngày`, color: "text-app-accent-success" },
      ...
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-app-text-secondary text-sm mt-1">Theo dõi hành trình h?c ti?ng Hàn c?a b?n</p>
          </div>
          <button
        ...
        <div className="bg-[#1a1d27] border border-app-border rounded-xl p-6">
          <div className="flex items-center justify-between mb-5">
            <div>
              ...
              <p className="text-white/35 text-xs mt-0.5">{totalStudyDays} ngày h?c trong 12 tháng qua</p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-[#1a1d27] border border-app-border rounded-xl p-5">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-white/35 text-xs mt-0.5">Ngày có ch?m vàng = dã h?c</p>
              </div>
          ...
          <div className="bg-[#1a1d27] border border-app-border rounded-xl p-5">
            <div className="mb-4">
              <h2 className="text-white font-semibold">Ngày h?c theo tháng</h2>
              <p className="text-white/35 text-xs mt-0.5">6 tháng g?n nh?t</p>
            </div>
        ...
        {/* Recent activity log */}
        <div className="bg-[#1a1d27] border border-app-border rounded-xl p-5">
          <h2 className="text-white font-semibold mb-4">Nh?t ký h?c t?p g?n dây</h2>
          <div className="space-y-2">
