  ...
  if (goal === "K-Pop & K-Drama") {
    return {
      ...
      items: [
        ...
        { week: "Tuần 3–5", title: "Học qua bài hát K-pop", tasks: ["Phân tích lời bài hát", "Flashcard từ vựng K-pop", "Luyện hát theo"], path: "/melon", icon: "ri-music-2-line", color: "#e8c84a" },
  ...
  if (goal === "Du lịch Hàn Quốc") {
    return {
      ...
      items: [
        ...
        { week: "Tuần 6", title: "Thực hành & Tự tin", tasks: ["Hội thoại AI thực tế", "Luyện phát âm chuẩn", "Từ điển cụm từ du lịch"], path: "/phrase-dictionary", icon: "ri-map-pin-line", color: "#e8c84a" },
      ],
    };
  }
    ...
    >
      ...
      {selected && (
        <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: color }}>
          <i className="ri-check-line text-[#0f1117] text-xs"></i>
        </div>
      )}
    </button>
  );
  ...
  return (
    <div className={`transition-all duration-500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
      ...
      <div className="text-center mb-6">
        <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-3" style={{ backgroundColor: "#e8c84a20" }}>
      ...
      <div className="rounded-2xl p-5 mb-4" style={{ backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div className="flex gap-3 mb-4">
          <div className="flex-1 rounded-xl p-3 text-center" style={{ backgroundColor: "rgba(232,200,74,0.08)", border: "1px solid rgba(232,200,74,0.15)" }}>
            <p className="text-[#e8c84a] font-bold text-lg">{roadmap.dailyTime}</p>
