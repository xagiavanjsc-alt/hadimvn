        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-app-text-secondary text-sm">Ð?u quiz realtime v?i d?i th? ng?u nhiên</p>
            </div>
          </div>
          ...
          {gameState === "lobby" && (
            <div className="space-y-6">
              ...
              <div className="bg-app-surface/50 border border-app-border rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {([
                    ...
                    { key: "medium", label: "Trung bình", desc: "T? A1-B1", color: "amber" },
                    { key: "hard", label: "Khó", desc: "T? A1-C1", color: "rose" },
                  ] as const).map(d => (
                    <button
                      key={d.key}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { icon: "ri-question-line", label: "S? câu h?i", value: `${TOTAL_QUESTIONS} câu` },
                  { icon: "ri-timer-line", label: "Th?i gian/câu", value: `${QUESTION_TIME}s` },
                  { icon: "ri-trophy-line", label: "Ði?m t?i da", value: "1,500+" },
                ].map((s, i) => (
            ...
            <div className="flex flex-col items-center justify-center py-20 space-y-8">
              <div className="flex items-center gap-12">
                ...
                <div className="text-center">
                  ...
                  <p className="text-app-text-secondary font-bold">Ðang tìm...</p>
              ...
              <p className="text-app-text-secondary text-sm animate-pulse">Ðang tìm d?i th? phù h?p...</p>
            </div>
          )}
          ...
          {gameState === "playing" && questions[currentQ] && opponent && (
            <div className="space-y-4">
              ...
              <div className="bg-app-surface/50 border border-app-border rounded-2xl p-8 text-center">
                <p className="text-app-text-secondary text-sm mb-3">T? này có nghia là gì?</p>
                ...
                {player.streak >= 3 && (
                  <div className="inline-flex items-center gap-1 bg-orange-500/20 border border-orange-500/30 rounded-full px-3 py-1 text-orange-400 text-xs mt-2">
                    ...
                    Chu?i {player.streak} câu dúng! +20 di?m bonus
                  </div>
                )}
              </div>
              ...
              {opponentAnswered && (
                <div className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm ${
                  ...
                  <span>{opponent.name} dã tr? l?i {opponentCorrect ? "dúng" : "sai"}!</span>
                </div>
              )}
            ...
            <div className="space-y-6">
              ...
              <div className={`rounded-2xl p-8 text-center border ${
                ...
                <h2 className={`text-2xl font-bold mb-2 ${
                  ...
                  {isDraw ? "Hòa!" : playerWon ? "Chi?n th?ng!" : "Thua r?i!"}
                </h2>
                <p className="text-white/50 text-sm">
                  {isDraw ? "Hai bên ngang tài ngang s?c!" : playerWon ? "Xu?t s?c! B?n dã dánh b?i d?i th?!" : "C? g?ng hon l?n sau nhé!"}
                </p>
              </div>
              ...
              <div className="bg-app-surface/50 border border-app-border rounded-2xl p-6">
                <div className="flex items-center justify-around">
                  <div className="text-center">
                    ...
                    <p className="text-app-text-secondary text-xs">{playerAnswers.filter(Boolean).length}/{TOTAL_QUESTIONS} dúng</p>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-app-text-secondary text-xs">{opponentAnswers.filter(Boolean).length}/{TOTAL_QUESTIONS} dúng</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-app-surface/50 border border-app-border rounded-2xl p-5">
                <h3 className="text-white font-semibold mb-4 text-sm">Chi ti?t t?ng câu</h3>
