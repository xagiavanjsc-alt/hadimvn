    ...
    >
      ...
      {isActive && (
        <div className="mt-5 pt-5 border-t border-white/5 space-y-4">
          {/* Skills */}
          <div>
            <p className="text-white/30 text-[10px] uppercase tracking-widest font-semibold mb-2">Kỹ năng cần đạt</p>
          ...
          {/* Grammar */}
          <div>
            <p className="text-white/30 text-[10px] uppercase tracking-widest font-semibold mb-2">Ngữ pháp trọng tâm</p>
          ...
          {matchedLessons.length > 0 && (
            <div>
              <p className="text-white/30 text-[10px] uppercase tracking-widest font-semibold mb-2">Bài học gợi ý từ kho của bạn</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white/40 text-[10px] uppercase tracking-widest font-semibold">Cấp độ hiện tại</p>
