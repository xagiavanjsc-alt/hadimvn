      ...
      {loading ? (
        ...
        <>
          <div className="rounded-xl border overflow-hidden mb-4" style={{ borderColor: "var(--admin-border)" }}>
            <div className="grid grid-cols-[2fr_1fr_2fr_1fr_1fr_auto] px-4 py-2.5 text-[10px] font-bold uppercase tracking-widest"
            ...
            <div className="divide-y" style={{ borderColor: "var(--admin-border)" }}>
              {vocab.length === 0 ? (
                ...
                <div key={v.id} className="grid grid-cols-[2fr_1fr_2fr_1fr_1fr_auto] px-4 py-3 items-center group"
                  ...
                  <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold w-fit ${v.topik_level === "I" ? "bg-emerald-500/15 text-emerald-400" : "bg-rose-500/15 text-rose-400"}`}>
                    TOPIK {v.topik_level}
                  </span>
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <>
          <div className="rounded-xl border overflow-hidden mb-4" style={{ borderColor: "var(--admin-border)" }}>
            <div className="grid grid-cols-[2fr_3fr_1fr_1fr_auto] px-4 py-2.5 text-[10px] font-bold uppercase tracking-widest"
              style={{ backgroundColor: "var(--admin-card2)", color: "var(--admin-text-faint)", borderBottom: "1px solid var(--admin-border)" }}>
