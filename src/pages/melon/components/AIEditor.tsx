  ...
  if (!song) {
    return (
      <section className="bg-app-bg border border-app-border rounded-xl p-10 flex flex-col items-center justify-center text-center min-h-[400px]">
        ...
        <p className="text-app-text-muted text-sm">Ch?n m?t bài hát t? b?ng trên</p>
        <p className="text-app-text-muted text-xs mt-1">ho?c nh?n "X? lý AI" d? b?t d?u biên t?p</p>
      </section>
    );
  }
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-app-border">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {draftSaved ? "Ðã luu nháp!" : "Luu nháp"}
          </button>
          {hasDraft && (
            <button
              onClick={deleteDraft}
      ...
      <div className="grid grid-cols-2 divide-x divide-white/5 min-h-[500px]">
        ...
        <div className="p-6 flex flex-col">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-white/50 text-xs font-medium tracking-normal">L?i g?c (Ti?ng Hàn)</span>
          </div>
        ...
        <div className="p-6 flex flex-col">
          ...
          <div className="flex gap-1 bg-app-card/50 p-1 rounded-lg mb-4">
            {(["story", "vocab", "explain"] as const).map((tab) => (
              ...
              >
                {tab === "story" ? "Truy?n Chêm" : tab === "vocab" ? "T? v?ng" : "Gi?i thích"}
              </button>
            ))}
          </div>
          ...
          <div className="flex-1">
            {activeTab === "story" && (
              <textarea
                ...
                placeholder="AI s? t? d?ng t?o do?n Truy?n Chêm ti?ng Vi?t t?i dây..."
            ...
            {activeTab === "explain" && (
              <textarea
                ...
                placeholder="AI s? gi?i thích cách dùng t? và ng? pháp t?i dây..."
                className="w-full h-full min-h-[340px] bg-app-surface/50 border border-app-border rounded-xl p-4 text-white/80 text-sm leading-7 placeholder-white/20 focus:outline-none focus:border-app-accent-primary/30 resize-none transition-colors"
              />
            )}
          </div>
