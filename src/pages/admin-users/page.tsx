  ...
  return (
    <div className="rounded-2xl border p-4 mb-4 space-y-4" style={{ backgroundColor: "var(--admin-card)", borderColor: "var(--admin-border2)" }}>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div>
          <p className="text-[10px] font-semibold mb-2 uppercase tracking-wider" style={{ color: "var(--admin-text-faint)" }}>Ngày đăng ký</p>
        ...
        <div>
          <p className="text-[10px] font-semibold mb-2 uppercase tracking-wider" style={{ color: "var(--admin-text-faint)" }}>XP tích lũy</p>
          <div className="space-y-2">
        ...
        <div>
          <p className="text-[10px] font-semibold mb-2 uppercase tracking-wider" style={{ color: "var(--admin-text-faint)" }}>Streak & Hoạt động</p>
          <div className="space-y-2">
        ...
        <div>
          <p className="text-[10px] font-semibold mb-2 uppercase tracking-wider" style={{ color: "var(--admin-text-faint)" }}>Loại VIP</p>
