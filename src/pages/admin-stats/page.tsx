    ...
    >
      ...
      <div className="grid grid-cols-3 gap-5 mb-6" style={{ contentVisibility: "auto", containIntrinsicHeight: "400px" }}>
        ...
        <div className="col-span-2 bg-[#0f1117] border border-white/5 rounded-2xl p-5">
          ...
          {revenues.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <p className="text-white/25 text-sm">Chưa có doanh thu nào</p>
        ...
        <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-5">
          ...
          <p className="text-white/30 text-xs mb-4">Top series bán chạy nhất</p>
                  ...
                  <div key={s.id}>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-white/30 text-[10px]">{s.sales} đơn</span>
                        <span className="text-emerald-400 text-xs font-bold">{formatVND(s.revenue)}</span>
                      </div>
                    </div>
      ...
      {/* Content breakdown */}
      <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-5 mb-6" style={{ contentVisibility: "auto", containIntrinsicHeight: "300px" }}>
        <h3 className="text-white font-semibold text-sm mb-4">Chi tiết nội dung</h3>
        <div className="grid grid-cols-2 gap-4">
          {contentStats.map(s => (
            <div key={s.label} className="flex items-center gap-3 px-4 py-3 bg-white/3 rounded-xl">
      ...
      {/* EPS image coverage */}
      <div className="bg-[#0f1117] border border-white/5 rounded-2xl p-5" style={{ contentVisibility: "auto", containIntrinsicHeight: "200px" }}>
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-white font-semibold text-sm">Độ phủ ảnh EPS</h3>
            <p className="text-white/30 text-xs mt-0.5">Câu hỏi có ảnh minh họa</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-emerald-400 text-sm font-bold">{stats.epsWithImage}</span>
            <span className="text-white/30 text-xs">/ {epsQuestions.length}</span>
            <span className="text-white/50 text-xs font-bold bg-white/5 px-2 py-1 rounded-lg">
