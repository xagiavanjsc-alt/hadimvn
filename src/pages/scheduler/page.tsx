      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="col-span-2 space-y-4">
          ...
          <div className="bg-[#0f1117] border border-white/5 rounded-xl p-5">
            ...
            {/* Day of week */}
            <div className="mb-5">
              <p className="text-white/40 text-xs tracking-normal mb-3">Ngày trong tuần</p>
            ...
            {/* Time */}
            <div className="mb-5">
              <p className="text-white/40 text-xs tracking-normal mb-3">Giờ quét</p>
              <div className="flex items-center gap-3">
                <div className="flex-1">
            ...
            {/* Notifications */}
            <div className="mb-5">
              <p className="text-white/40 text-xs tracking-normal mb-3">Thông báo khi có bài mới</p>
          ...
          <div className="bg-[#0f1117] border border-white/5 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-white/40 text-xs tracking-normal">Cách hoạt động</p>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#0f1117] border border-white/5 rounded-xl p-4">
            <p className="text-white/30 text-[10px] tracking-normal mb-4">Thống kê</p>
            <div className="space-y-3">
          ...
          {/* Scan logs */}
          <div className="bg-[#0f1117] border border-white/5 rounded-xl p-4">
            <p className="text-white/30 text-[10px] tracking-normal mb-3">Lịch sử quét</p>
            <div className="space-y-2">
              {logs.length === 0 ? (
