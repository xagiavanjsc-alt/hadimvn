      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div className="col-span-2 space-y-4">
          ...
          {config.enabled && nextRunDate && (
            <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl px-5 py-4 flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-app-accent-success font-semibold text-sm">Lần quét tiếp theo</p>
          ...
          <div className="bg-app-bg border border-app-border rounded-xl p-5">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-app-text-secondary text-xs">Chọn ngày và giờ quét tự động</p>
              </div>
            </div>

            {/* Day of week */}
            <div className="mb-5">
              <p className="text-app-text-secondary text-xs tracking-normal mb-3">Ngày trong tuần</p>
            ...
            {/* Time */}
            <div className="mb-5">
              <p className="text-app-text-secondary text-xs tracking-normal mb-3">Giờ quét</p>
              <div className="flex items-center gap-3">
                <div className="flex-1">
                  <label className="text-app-text-muted text-[10px] mb-1.5 block">Giờ</label>
                  <select
                    value={config.hour}
            ...
            {/* Notifications */}
            <div className="mb-5">
              <p className="text-app-text-secondary text-xs tracking-normal mb-3">Thông báo khi có bài mới</p>
          ...
          <div className="bg-app-bg border border-app-border rounded-xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-app-text-secondary text-xs tracking-normal">Cách hoạt động</p>
            </div>
            <div className="space-y-3">
              {[
                { icon: "ri-calendar-check-line", color: "text-app-accent-primary", title: "Lịch được lưu local", desc: "Lịch quét lưu trong trình duyệt — cần mở tab KTS đúng giờ để kích hoạt" },
                ...
                { icon: "ri-history-line", color: "text-app-accent-success", title: "Lịch sử quét", desc: "Mỗi lần quét được ghi lại — xem bao nhiêu bài mới mỗi tuần" },
              ].map((item) => (
        ...
        <div className="space-y-4">
          ...
          <div className="bg-app-bg border border-app-border rounded-xl p-4">
            <p className="text-app-text-muted text-[10px] tracking-normal mb-4">Thống kê</p>
            <div className="space-y-3">
          ...
          {/* Scan logs */}
          <div className="bg-app-bg border border-app-border rounded-xl p-4">
            <p className="text-app-text-muted text-[10px] tracking-normal mb-3">Lịch sử quét</p>
            <div className="space-y-2">
              {logs.length === 0 ? (
                <p className="text-app-text-muted text-xs text-center py-4">Chưa có lịch sử</p>
              ) : (
                logs.map((log) => (
