      ...
      <div className="w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-2xl border"
        ...
        <div className="p-5 space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-[10px] font-semibold uppercase tracking-wider mb-1.5 block" style={{ color: "var(--admin-text-faint)" }}>Tên gói *</label>
            ...
            <div>
              <label className="text-[10px] font-semibold uppercase tracking-wider mb-1.5 block" style={{ color: "var(--admin-text-faint)" }}>Badge (tùy chọn)</label>
          ...
          <div>
            <label className="text-[10px] font-semibold uppercase tracking-wider mb-1.5 block" style={{ color: "var(--admin-text-faint)" }}>Mô tả</label>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label className="text-[10px] font-semibold uppercase tracking-wider mb-1.5 block" style={{ color: "var(--admin-text-faint)" }}>Giá/tháng (VNĐ)</label>
              <input type="number" min={0} value={edited.price} onChange={e => setEdited(p => ({ ...p, price: parseInt(e.target.value) || 0 }))}
                className="w-full rounded-xl px-3 py-2.5 text-sm outline-none border"
                style={{ backgroundColor: "var(--admin-card2)", color: "var(--admin-text)", borderColor: "var(--admin-border2)" }} />
            </div>
            <div>
              <label className="text-[10px] font-semibold uppercase tracking-wider mb-1.5 block" style={{ color: "var(--admin-text-faint)" }}>Giá năm (VNĐ)</label>
              <input type="number" min={0} value={edited.yearlyPrice} onChange={e => setEdited(p => ({ ...p, yearlyPrice: parseInt(e.target.value) || 0 }))}
                className="w-full rounded-xl px-3 py-2.5 text-sm outline-none border"
                style={{ backgroundColor: "var(--admin-card2)", color: "var(--admin-text)", borderColor: "var(--admin-border2)" }} />
            </div>
            <div>
              <label className="text-[10px] font-semibold uppercase tracking-wider mb-1.5 block" style={{ color: "var(--admin-text-faint)" }}>Ngày dùng thử</label>
          ...
          {/* Color picker */}
          <div>
            <label className="text-[10px] font-semibold uppercase tracking-wider mb-2 block" style={{ color: "var(--admin-text-faint)" }}>Màu sắc</label>
          ...
          {/* Features */}
          <div>
            <label className="text-[10px] font-semibold uppercase tracking-wider mb-2 block" style={{ color: "var(--admin-text-faint)" }}>Tính năng ({edited.features.length})</label>
    ...
    <div className={`relative rounded-2xl border overflow-hidden transition-all ${!plan.active ? "opacity-50" : ""}`}
      ...
      <div className="p-5">
        ...
        <div className="flex items-end gap-3 mb-4">
          <div>
            <p className="text-[10px] uppercase tracking-wider mb-0.5" style={{ color: "var(--admin-text-faint)" }}>Hàng tháng</p>
          ...
          {plan.yearlyPrice > 0 && (
            <div className="mb-0.5">
              <p className="text-[10px] uppercase tracking-wider mb-0.5" style={{ color: "var(--admin-text-faint)" }}>Hàng năm</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-3 flex-wrap">
                  <span className="text-[10px] px-2 py-1 rounded-full font-semibold bg-emerald-500/15 text-emerald-400">✓ Đã deploy</span>
