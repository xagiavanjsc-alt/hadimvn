...
const GRAMMAR_PATTERNS: GrammarPattern[] = [
  ...
  },
  {
    ...
    level: "TOPIK 2",
    levelColor: "#3b82f6",
    pattern: "N – 에 비해(서) / 에 비하면",
    meaning: "So với..., so sánh với...",
    explanation: "Dùng để so sánh hai đối tượng, trong đó một bên được lấy làm mức chuẩn. '에 비해서' nhấn mạnh sự chênh lệch so với kỳ vọng hoặc chuẩn mực. Thường dùng khi kết quả bất ngờ so với tiêu chuẩn đó.",
    formation: "N + 에 비해(서) / N + 에 비하면",
    notes: [
      "Phân biệt với -보다: 보다 so sánh hơn/kém trực tiếp; 에 비해서 nhấn mạnh chênh lệch so với mức chuẩn.",
      "Phân biệt với -에 따라서: 에 따라서 = tùy theo, phụ thuộc vào.",
      "에 비하면 = nếu so với..., giả định hơn.",
    ],
    examples: [
      { korean: "가격에 비해서 품질이 좋아요.", vietnamese: "So với giá thì chất lượng tốt." },
      { korean: "작년에 비해 물가가 많이 올랐어요.", vietnamese: "So với năm ngoái, vật giá tăng nhiều." },
      { korean: "기대에 비해 결과가 좋지 않았어요.", vietnamese: "So với kỳ vọng thì kết quả không tốt." },
      { korean: "한국에 비해서 다른 나라는 사투리 차이가 더 커요.", vietnamese: "So với Hàn Quốc, ở các nước khác sự khác biệt phương ngữ lớn hơn." },
    ],
    exercises: [
      { question: "가격 ___ 품질이 좋아요.", options: ["에 비해서", "에 따라서", "에 대해서", "에 의해서"], answer: 0, explanation: "N + 에 비해서 = so với N (lấy N làm mức chuẩn để so sánh)." },
      { question: "작년 ___ 물가가 많이 올랐어요.", options: ["에 비해", "에 따라", "에 대해", "에 의해"], answer: 0, explanation: "에 비해(서) = so với, nhấn mạnh sự chênh lệch so với thời điểm trước." },
    ],
    commonMistakes: [
      "Nhầm với -보다 (보다 so sánh trực tiếp hơn/kém; 에 비해서 lấy N làm chuẩn, nhấn mạnh chênh lệch).",
      "Nhầm với -에 따라(서) (에 따라서 = tùy theo/phụ thuộc vào, không phải so sánh).",
    ],
    tags: ["So sánh", "Chênh lệch", "Chuẩn mực", "TOPIK 2"],
  },
  {
    id: "topik2-120",
    level: "TOPIK 2",
    levelColor: "#3b82f6",
    pattern: "A/V – 는 것이 맞다 / 틀리다",
    meaning: "Đúng khi... / Sai khi...",
    explanation: "Dùng để đánh giá tính đúng sai của một hành động theo chuẩn mực đạo đức hoặc quy tắc xã hội. '는 것이 맞다' = đúng khi làm..., '는 것이 틀리다' = sai khi làm... Khác với 것 같다 (suy đoán).",
    formation: "V + 는 것이 맞다/틀리다 / A + (으)ㄴ 것이 맞다/틀리다",
    notes: [
      "Phân biệt '틀리다' (sai về mặt chuẩn mực) và '다르다' (khác biệt).",
      "Phân biệt với '것 같다' (suy đoán chủ quan, không phải đánh giá đúng/sai).",
      "Thường dùng khi nêu quan điểm về chuẩn mực đạo đức hoặc phép lịch sự.",
    ],
    examples: [
      { korean: "어른에게 자리를 양보하는 것이 맞아요.", vietnamese: "Nhường chỗ cho người lớn tuổi là đúng." },
      { korean: "남의 물건을 훔치는 것이 틀려요.", vietnamese: "Trộm đồ của người khác là sai." },
      { korean: "약속을 지키는 것이 맞아요.", vietnamese: "Giữ lời hứa mới là đúng." },
      { korean: "거짓말을 하는 것이 틀린 거 아닌가요?", vietnamese: "Nói dối là sai, không phải sao?" },
    ],
    exercises: [
      { question: "어른에게 자리를 양보하 ___ 맞아요.", options: ["는 것이", "ㄴ 것이", "ㄹ 것이", "는 게"], answer: 0, explanation: "V-는 것이 맞다 = đúng khi làm... (động từ thì + 는 것이)." },
      { question: "거짓말을 하 ___ 틀려요.", options: ["는 것이", "ㄴ 것이", "ㄹ 것이", "는 데"], answer: 0, explanation: "V-는 것이 틀리다 = sai khi làm..." },
    ],
    commonMistakes: [
      "Nhầm '것이 맞다' và '것 같다' (맞다 = đúng/chuẩn mực, 것 같다 = có vẻ/suy đoán).",
      "Nhầm '틀리다' và '다르다' (틀리다 = sai về chuẩn mực, 다르다 = chỉ khác biệt, không hàm ý sai).",
    ],
    tags: ["Đạo đức", "Chuẩn mực", "Đúng sai", "TOPIK 2"],
  },
  {
    id: "topik2-121",
    level: "TOPIK 2",
    levelColor: "#3b82f6",
    pattern: "A/V – 아/어서는 안 되다",
    meaning: "Không được... (vì hành động đó)",
    explanation: "Kết hợp -아/어서 (cách thức/nguyên nhân) với -면 안 되다 (không được). Diễn đạt điều cấm kỵ hoặc hành động không nên làm, nhấn mạnh lý do chính là bản thân hành động đó. Mạnh hơn và có tính quy tắc xã hội hơn -(으)면 안 되다.",
    formation: "V + 아/어서는 안 되다",
    notes: [
      "아/어서는 안 되다 nhấn mạnh chính hành động đó không được làm (lý do nằm ở hành động).",
      "-(으)면 안 되다 nhấn mạnh điều kiện không được xảy ra.",
      "Phân biệt với -지 말다 (mệnh lệnh trực tiếp dừng hành động).",
    ],
    examples: [
      ...
      { korean: "공공장소에서 큰 소리를 내서는 안 돼요.", vietnamese: "Không được tạo tiếng ồn lớn ở nơi công cộng." },
      { korean: "약속을 어겨서는 안 돼요.", vietnamese: "Không được phá vỡ lời hứa." },
    ],
    exercises: [
      { question: "한밤중에 악기를 연주 ___ 안 돼요.", options: ["해서는", "하면", "해도", "해야"], answer: 0, explanation: "아/어서는 안 되다 = không được (nhấn mạnh chính hành động đó là điều cấm)." },
      { question: "남에게 불편을 줘 ___ 안 돼요.", options: ["서는", "면", "도", "야"], answer: 0, explanation: "줘서는 안 되다 = không được gây... (서는 rút gọn từ 아/어서는)." },
    ],
    commonMistakes: [
      "Nhầm với -(으)면 안 되다 (nghĩa gần giống nhưng 서는 nhấn mạnh lý do ở chính hành động).",
      "Nhầm với -지 말다 (말다 là lệnh trực tiếp; 서는 안 되다 là quy tắc/chuẩn mực xã hội).",
    ],
    tags: ["Cấm", "Không được", "Quy tắc xã hội", "TOPIK 2"],
  },
  {
    id: "topik2-122",
    level: "TOPIK 2",
    levelColor: "#3b82f6",
    pattern: "A/V – (으)ㄹ 리가 없다",
    meaning: "Không thể nào..., không có lý gì...",
    explanation: "Diễn đạt sự phủ định mạnh — người nói cho rằng không có cơ sở, không có lý do nào để sự việc đó xảy ra. Thể hiện sự hoài nghi mạnh hoặc bác bỏ một khả năng. Mạnh hơn '(으)ㄹ 수 없다' (không thể về mặt khách quan).",
    formation: "V + (으)ㄹ 리가 없다 / A + (으)ㄹ 리가 없다",
    notes: [
      "리 (理) = lý do, cơ sở → '리가 없다' = không có lý do/cơ sở.",
      "Phân biệt với '(으)ㄹ 수 없다': 수 없다 = không có khả năng vật lý; 리가 없다 = không có cơ sở lý luận.",
      "Dạng ngạc nhiên: '(으)ㄹ 리가 없다니!' = Không thể tin được!",
    ],
    examples: [
      { korean: "그 사람이 거짓말을 할 리가 없어요.", vietnamese: "Không thể nào người đó lại nói dối." },
      { korean: "이렇게 비쌀 리가 없어요.", vietnamese: "Không thể nào đắt thế này được." },
      { korean: "그가 모를 리가 없어요.", vietnamese: "Không có lý gì mà anh ấy không biết." },
      { korean: "외계인이 존재할 리가 없어요.", vietnamese: "Không thể nào người ngoài hành tinh lại tồn tại." },
    ],
    exercises: [
      { question: "그 사람이 거짓말을 ___ 리가 없어요.", options: ["할", "하는", "했을", "하면"], answer: 0, explanation: "(으)ㄹ 리가 없다: động từ chia dạng (으)ㄹ rồi thêm 리가 없다." },
      { question: "이렇게 비쌀 ___ 없어요.", options: ["리가", "것이", "줄을", "만큼"], answer: 0, explanation: "리가 없다 = không có cơ sở/lý do để... xảy ra." },
    ],
    commonMistakes: [
      "Nhầm với '(으)ㄹ 수 없다' (수 없다 = không thể về mặt khách quan/vật lý; 리가 없다 = không có cơ sở lý luận).",
      "Quên chia động từ sang dạng (으)ㄹ trước 리가 없다.",
    ],
    tags: ["Phủ định mạnh", "Hoài nghi", "Bác bỏ", "TOPIK 2"],
  },
  {
    id: "topik2-123",
    level: "TOPIK 2",
    levelColor: "#3b82f6",
    pattern: "A/V – (으)ㄴ/는지 모르다",
    meaning: "Không biết... có không, không rõ...",
    explanation: "Diễn đạt sự không chắc chắn hoặc thiếu thông tin về một sự việc. Kết hợp mệnh đề gián tiếp (-는지/-ㄴ지) với 모르다. Phân biệt với '-(으)ㄹ지 모르다' (không biết điều sẽ xảy ra trong tương lai).",
    formation: "V-는지 모르다 (hiện tại) / A-(으)ㄴ지 모르다 / V-(으)ㄹ지 모르다 (tương lai/chưa chắc)",
    notes: [
      "-는지 모르다 = không biết sự thật hiện tại/thói quen.",
      "-(으)ㄴ지 모르다 = không biết trạng thái hiện tại (tính từ hoặc V quá khứ).",
      "-(으)ㄹ지 모르다 = không biết điều sẽ xảy ra.",
      "Phân biệt với '-는지 알다' (알다 = biết rằng...).",
    ],
    examples: [
      { korean: "그가 오는지 모르겠어요.", vietnamese: "Không biết anh ấy có đến hay không." },
      { korean: "이게 맞는지 모르겠어요.", vietnamese: "Không biết cái này có đúng không." },
      { korean: "언제 끝나는지 모르겠어요.", vietnamese: "Không biết khi nào thì kết thúc." },
      { korean: "외계인이 존재하는지 모르겠어요.", vietnamese: "Không biết người ngoài hành tinh có tồn tại hay không." },
    ],
    exercises: [
      { question: "그가 오 ___ 모르겠어요.", options: ["는지", "ㄴ지", "ㄹ지", "는데"], answer: 0, explanation: "V-는지 모르다 = không biết có... hay không (hiện tại)." },
      { question: "언제 끝나 ___ 모르겠어요.", options: ["는지", "ㄴ지", "ㄹ지", "는데"], answer: 0, explanation: "끝나다 là động từ → 끝나는지 모르다 (hiện tại, không biết khi nào kết thúc)." },
    ],
    commonMistakes: [
      "Nhầm '-는지 모르다' và '-(으)ㄹ지 모르다' (는지 = sự thật hiện tại; ㄹ지 = điều chưa xảy ra).",
      "Nhầm '-는지 알다/모르다' với '-는지 궁금하다' (궁금하다 = tò mò muốn biết; 모르다 = xác nhận không biết).",
    ],
    tags: ["Gián tiếp", "Không chắc chắn", "Thiếu thông tin", "TOPIK 2"],
  },
];
