...
const GRAMMAR_PATTERNS: GrammarPattern[] = [
  ...
  },
  {
    ...
    examples: [
      { korean: "환경오염으로 인해서 자연생태계가 위협을 받고 있습니다.", vietnamese: "Do ô nhiễm môi trường, hệ sinh thái tự nhiên đang bị đe dọa." },
  ...
  },
  {
    ...
    examples: [
      { korean: "기숙사 생활을 하느니만치 각자가 약간의 불편을 감수해야 한다.", vietnamese: "Tất cả cùng nhau sinh hoạt chung trong ký túc xá nên mỗi người phải chấp nhận một chút bất tiện." },
  ...
  },
  {
    ...
    examples: [
      ...
      { korean: "이 회사의 직원인 이상 이 행사에 꼭 참여해야 돼요.", vietnamese: "Nếu đã là nhân viên của công ty thì tôi cũng nhất định phải tham gia sự kiện lần này." },
  ...
  },
  {
    ...
    formation: "V + (느)ㄴ답시고",
    examples: [
      { korean: "온라인 강의를 듣는답시고 컴퓨터를 사 놓고 게임만 해요.", vietnamese: "Minho bảo là học online nên mua máy tính mà lại chỉ chơi game thôi." },
      { korean: "다이어트한답시고 일주일도 안 돼서 폭식했어요.", vietnamese: "Bạn mình bảo là ăn kiêng mà chưa đầy một tuần đã ăn rất nhiều." },
  ...
  },
  {
    ...
    examples: [
      { korean: "한글을 창제함으로써 언어 생활을 편리하게 만들었어요.", vietnamese: "Bằng việc sáng tạo chữ Hàn, ngôn ngữ sinh hoạt đã trở nên thuận tiện." },
