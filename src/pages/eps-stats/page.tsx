              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="pt-2 border-t border-app-border">
                    <p className="text-app-text-muted text-[10px]">Tổng: {vocabStats.total} từ EPS chuẩn</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-app-bg border border-app-border rounded-2xl p-5">
              ...
              {scoreTrend.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-24 text-center">
                  ...
                  <p className="text-app-text-muted text-xs">Chưa có dữ liệu thi</p>
                  <button onClick={() => navigate("/eps-exam")} className="mt-2 text-app-accent-primary text-xs cursor-pointer whitespace-nowrap">Thi thử ngay →</button>
                </div>
              ) : (
              ...
              {examStats && (
                <div className="mt-3 pt-3 border-t border-app-border flex items-center gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-app-text-muted text-[10px]">Thời gian TB</p>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="space-y-5">
          {examResults.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 bg-app-bg border border-app-border rounded-2xl text-center">
              ...
              <p className="text-app-text-muted text-sm">Chưa có kết quả thi nào</p>
          ...
          <div className="bg-app-bg border border-app-border rounded-2xl p-6">
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-app-text-secondary text-sm mb-4">{vocabStats.mastered} / {vocabStats.total} từ đã thuộc</p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {vocabStats.byTopic.filter(t => t.total > 0).map(topic => (
                <div key={topic.id} className="bg-app-surface/50 rounded-xl p-4">
                  ...
                  <p className="text-app-text-muted text-[10px]">{topic.mastered}/{topic.total} từ</p>
                </div>
              ))}
            </div>
          </div>
                ...
                <div key={topic.id} className="bg-app-bg border border-app-border rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-app-text-muted text-[10px]">{qs.length} câu hỏi</p>
                    </div>
                  </div>
