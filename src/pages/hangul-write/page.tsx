          ...
          <div className="bg-[#0f1117] border border-white/8 rounded-2xl p-5">
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Stroke order */}
                <div>
                  <p className="text-white/25 text-[10px] uppercase tracking-widest mb-1.5">Thứ tự nét viết</p>
                ...
                {score !== null ? (
                  ...
                  <div className="space-y-2">
                    <div className="bg-white/3 rounded-xl p-3">
                      <p className="text-white/30 text-[10px] uppercase tracking-widest mb-2">Hướng dẫn</p>
                    ...
                    <div className="bg-white/3 rounded-xl p-3">
                      <p className="text-white/30 text-[10px] uppercase tracking-widest mb-2">Ký tự tiếp theo</p>
                      <div className="flex gap-2">
