...
const ARTICLES: NewsArticle[] = [
  {
    ...
    source: "한국경제",
    readTime: "3분",
    thumbnail: "https://readdy.ai/api/search-image?query=Korean%20economy%20growth%20chart%20business%20Seoul%20financial%20district%20modern%20buildings&width=600&height=340&seq=news1&orientation=landscape",
    views: 12400,
    tags: ["경제", "성장", "전망"],
    vocab: [
...
Các chính sách cải thiện môi trường đầu tư và tạo việc làm cũng sẽ được công bố cùng lúc.`,
  },
  {
    ...
    source: "서울신문",
    readTime: "2분",
    thumbnail: "https://readdy.ai/api/search-image?query=Seoul%20subway%20metro%20station%20modern%20interior%20passengers%20commuting%20Korea&width=600&height=340&seq=news2&orientation=landscape",
    views: 8900,
    tags: ["서울", "지하철", "교통"],
    vocab: [
...
Giá vé sẽ được áp dụng giống như tàu điện ngầm hiện tại, và việc chuyển tuyến cũng hoàn toàn tự do.`,
  },
  {
    ...
    source: "문화일보",
    readTime: "4분",
    thumbnail: "https://readdy.ai/api/search-image?query=K-pop%20Korean%20wave%20Hallyu%20concert%20stage%20colorful%20lights%20fans%20performance&width=600&height=340&seq=news3&orientation=landscape",
    views: 24600,
    tags: ["K-팝", "한류", "문화"],
    vocab: [
...
Số người học tiếng Hàn cũng tăng mạnh, với thống kê cho thấy số người học tiếng Hàn trên toàn thế giới đã vượt 10 triệu người.`,
  },
  {
    ...
    source: "기상청",
    readTime: "1분",
    thumbnail: "https://readdy.ai/api/search-image?query=Korea%20winter%20snow%20Seoul%20city%20street%20cold%20weather%20snowfall%20beautiful&width=600&height=340&seq=news4&orientation=landscape",
    views: 31200,
    tags: ["날씨", "눈", "겨울"],
    vocab: [
...
Khuyến khích sử dụng phương tiện công cộng, và khi lái xe riêng cần đặc biệt chú ý lái xe an toàn.`,
  },
  {
    ...
    source: "조선일보",
    readTime: "3분",
    thumbnail: "https://readdy.ai/api/search-image?query=Korean%20food%20healthy%20traditional%20kimchi%20bibimbap%20colorful%20dishes%20table%20spread&width=600&height=340&seq=news5&orientation=landscape",
    views: 18700,
    tags: ["음식", "건강", "김치"],
    vocab: [
...
Chính phủ Hàn Quốc đang thúc đẩy nhiều chính sách hỗ trợ để toàn cầu hóa ẩm thực Hàn Quốc.`,
  },
  {
    ...
    source: "교육신문",
    readTime: "4분",
    thumbnail: "https://readdy.ai/api/search-image?query=Korean%20education%20classroom%20AI%20technology%20students%20learning%20digital%20tablets%20modern%20school&width=600&height=340&seq=news6&orientation=landscape",
    views: 9800,
    tags: ["교육", "AI", "기술"],
    vocab: [
