      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4 py-3 sm:py-5 space-y-3 sm:space-y-5">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <div className="flex-1 bg-[#0f1117] border border-white/5 rounded-2xl p-3 sm:p-4">
            <p className="text-white/40 text-xs font-semibold uppercase tracking-widest mb-2 sm:mb-3">
        ...
        {/* ── Learning paths ── */}
        <div>
          <h2 className="text-white/60 text-xs font-semibold uppercase tracking-widest mb-2 sm:mb-3">
            Lộ trình học
          </h2>
