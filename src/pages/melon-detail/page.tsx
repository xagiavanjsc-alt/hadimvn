  ...
  return (
    <div className="mt-10 pb-8">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-white/70 text-sm font-semibold uppercase tracking-wider">Bài hát liên quan</h2>
      </div>
          ...
          <div className={tab === "lyrics" ? "block" : "hidden lg:block"}>
            <div className="bg-white/3 rounded-2xl border border-white/5 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-white/60 text-xs font-medium uppercase tracking-wider">Lời bài hát (Tiếng Hàn)</span>
              </div>
                ...
                <div className="hidden lg:space-y-4 lg:block">
                  <div className="bg-white/3 rounded-2xl border border-white/5 p-5">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-white/60 text-xs font-medium uppercase tracking-wider">Truyện Chêm</span>
                    </div>
                  ...
                  <div className="bg-white/3 rounded-2xl border border-white/5 p-5">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-white/60 text-xs font-medium uppercase tracking-wider">Từ vựng</span>
                    </div>
                  ...
                  <div className="bg-white/3 rounded-2xl border border-white/5 p-5">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-white/60 text-xs font-medium uppercase tracking-wider">Phân tích ngữ pháp</span>
                    </div>
