...
export default function MelonDetailPage() {
  ...
  if (!song) {
    return (
      <div className="min-h-screen bg-app-bg flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-white/50 text-base">Không tìm th?y bài hát</p>
  ...
  const TABS: { key: Tab; label: string; icon: string; disabled?: boolean }[] = [
    { key: "lyrics", label: "L?i bài hát", icon: "ri-music-line" },
    { key: "story", label: "Truy?n Chêm", icon: "ri-book-open-line", disabled: !result },
    { key: "vocab", label: "T? v?ng", icon: "ri-translate-2", disabled: !result },
    { key: "grammar", label: "Ng? pháp", icon: "ri-graduation-cap-line", disabled: !result },
  ];
        ...
        {showKeyInput && !result && (
          <div className="bg-app-accent-primary/5 border border-app-accent-primary/15 rounded-2xl p-5 mb-6">
            <p className="text-white/60 text-sm mb-3">
              ...
              Nh?p API Key d? phân tích AI (ch? c?n nh?p 1 l?n)
            </p>
          ...
          <div className={tab === "lyrics" ? "block" : "hidden lg:block"}>
            <div className="bg-app-surface/50 rounded-2xl border border-app-border p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-white/60 text-xs font-medium tracking-normal">L?i bài hát (Ti?ng Hàn)</span>
              </div>
          ...
          <div className={tab !== "lyrics" ? "block" : "hidden lg:block"}>
            {loading && (
              <div className="bg-app-surface/50 rounded-2xl border border-app-border p-10 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-white/50 text-sm">AI dang phân tích...</p>
              </div>
            )}
            {!result && !loading && (
              <div className="bg-app-surface/50 rounded-2xl border border-app-border p-10 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-app-text-muted text-sm">Nh?n &ldquo;Phân tích AI&rdquo; d? xem n?i dung h?c ti?ng Hàn</p>
              </div>
            )}
            {result && !loading && (
              <div>
                <div className="flex gap-1 bg-app-card/50 p-1 rounded-xl mb-4 lg:hidden">
                  {(["story", "vocab", "grammar"] as Tab[]).map((t) => (
                    ...
                    >
                      {t === "story" ? "Truy?n Chêm" : t === "vocab" ? "T? v?ng" : "Ng? pháp"}
                    </button>
                  ))}
                </div>
                ...
                <div className="hidden lg:space-y-4 lg:block">
                  <div className="bg-app-surface/50 rounded-2xl border border-app-border p-5">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-white/60 text-xs font-medium tracking-normal">Truy?n Chêm</span>
                    </div>
                  ...
                  <div className="bg-app-surface/50 rounded-2xl border border-app-border p-5">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-white/60 text-xs font-medium tracking-normal">Phân tích ng? pháp</span>
                    </div>
