...
function JournalForm({ initial, onSave, onCancel }: JournalFormProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-6">
      ...
      {/* Date */}
      <div className="mb-4">
        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Ngày học</label>
        <input
          type="date"
          value={date}
      ...
      {/* Mood */}
      <div className="mb-4">
        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Cảm xúc hôm nay</label>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div>
          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Thời gian học (phút)</label>
          <input
            type="number"
            value={studyMinutes}
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Số từ đã học</label>
          <input
            type="number"
            value={wordsLearned}
      ...
      {/* Tags */}
      <div className="mb-5">
        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Chủ đề học</label>
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-5 mb-6">
      ...
      <div className="border-t border-gray-50 pt-4">
        <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mb-3">Điểm cảm xúc trung bình mỗi tuần</p>
      ...
      <div className="border-t border-gray-50 pt-4 mt-2">
        <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider mb-3">Phân bố cảm xúc (28 ngày qua)</p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-6">
          ...
          {entries.length >= 3 && (
            <div className="mt-6 bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Thống kê trung bình</p>
