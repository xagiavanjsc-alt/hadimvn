...
const MOODS = [
  ...
  { value: "okay", label: "Bình thu?ng", icon: "ri-emotion-normal-line", color: "#fbbf24" },
  { value: "tired", label: "M?t m?i", icon: "ri-emotion-unhappy-line", color: "#f87171" },
  { value: "hard", label: "Khó khan", icon: "ri-emotion-sad-line", color: "#a78bfa" },
];

const PRESET_TAGS = ["EPS-TOPIK", "Ng? pháp", "T? v?ng", "Nghe", "Nói", "Ð?c", "Vi?t", "Flashcard", "Quiz", "Giao ti?p"];
...
function ShareJournalModal({ entry, onClose }: ShareJournalModalProps) {
  ...
  const handleCopyText = useCallback(() => {
    const text = [
      `?? Nh?t ký h?c ti?ng Hàn — ${formatDate(entry.date)}`,
      `${mood.label} | ${entry.studyMinutes} phút | ${entry.wordsLearned} t?`,
      entry.content ? `\n"${entry.content}"` : "",
        ...
        <div className="p-5">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4 relative z-10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/70 text-xs font-semibold">Nh?t ký h?c ti?ng Hàn</span>
              </div>
              <span className="text-app-text-secondary text-[10px]">Hàn Qu?c Oi!</span>
            </div>
          ...
          <div className="flex gap-3 mt-4">
            ...
            >
              ...
              {copied ? "Ðã sao chép!" : "Sao chép text"}
            </button>
            <button
            ...
            >
              ...
              {downloading ? "Ðang t?o..." : "T?i ?nh"}
            </button>
          </div>

          <p className="text-center text-xs text-gray-400 mt-3">
            Chia s? lên Facebook, Zalo, Instagram d? truy?n c?m h?ng h?c ti?ng Hàn!
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-6">
      <h3 className="font-semibold text-gray-900 mb-5 flex items-center gap-2">
        ...
        {initial ? "Ch?nh s?a nh?t ký" : "Ghi nh?t ký hôm nay"}
      </h3>

      {/* Date */}
      <div className="mb-4">
        <label className="block text-xs font-semibold text-gray-500 tracking-normal mb-1.5">Ngày h?c</label>
        <input
          type="date"
          value={date}
      ...
      {/* Mood */}
      <div className="mb-4">
        <label className="block text-xs font-semibold text-gray-500 tracking-normal mb-1.5">C?m xúc hôm nay</label>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div>
          <label className="block text-xs font-semibold text-gray-500 tracking-normal mb-1.5">Th?i gian h?c (phút)</label>
          <input
            type="number"
            value={studyMinutes}
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-500 tracking-normal mb-1.5">S? t? dã h?c</label>
          <input
            type="number"
            value={wordsLearned}
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          placeholder="Hôm nay tôi dã h?c du?c gì? Ði?u gì khó? Ði?u gì thú v??..."
          rows={4}
      ...
      <div className="mb-5">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Thêm tag tùy ch?nh..."
      ...
      <div className="flex gap-3">
        ...
        >
          {initial ? "Luu thay d?i" : "Luu nh?t ký"}
        </button>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-5 mb-6">
                ...
                >
                  ...
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 hidden group-hover:block z-10 pointer-events-none">
                    <div className="bg-gray-900 text-white text-[10px] px-2 py-1 rounded-lg whitespace-nowrap">
                      {day.mood ? `${mood?.label} · ${day.minutes}p` : "Không h?c"}
                    </div>
                  </div>
                </div>
              );
      ...
      <div className="border-t border-gray-50 pt-4">
        <p className="text-[10px] text-gray-400 font-semibold tracking-normal mb-3">Ði?m c?m xúc trung bình m?i tu?n</p>
      ...
      <div className="border-t border-gray-50 pt-4 mt-2">
        <p className="text-[10px] text-gray-400 font-semibold tracking-normal mb-3">Phân b? c?m xúc (28 ngày qua)</p>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-100 px-6 py-5">
          <div className="max-w-5xl mx-auto flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">Ghi l?i hành trình h?c ti?ng Hàn c?a b?n</p>
            </div>
            {!showForm && (
              <button
        ...
        <div className="max-w-5xl mx-auto px-6 py-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            {[
              { icon: "ri-calendar-check-line", label: "T?ng ngày ghi", value: entries.length, color: "app-accent-primary", unit: "ngày" },
              ...
              { icon: "ri-fire-line", label: "Streak hi?n t?i", value: streak, color: "#f87171", unit: "ngày" },
            ].map(stat => (
          ...
          {entries.length > 0 && (
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              >
                <option value="all">T?t c? c?m xúc</option>
          ...
          {entries.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-xl border border-gray-100">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Chua có nh?t ký nào</h3>
              <p className="text-sm text-gray-400 mb-5">B?t d?u ghi l?i hành trình h?c ti?ng Hàn c?a b?n!</p>
              <button
              ...
              >
                Vi?t nh?t ký d?u tiên
              </button>
            </div>
          ) : filtered.length === 0 ? (
            <div className="text-center py-12 text-gray-400">
              <i className="ri-search-line text-3xl mb-2 block"></i>
              <p className="text-sm">Không tìm th?y nh?t ký phù h?p</p>
            </div>
          ) : (
          ...
          {entries.length >= 3 && (
            <div className="mt-6 bg-white rounded-xl border border-gray-100 p-4">
              <p className="text-xs font-semibold text-gray-500 tracking-normal mb-3">Th?ng kê trung bình</p>
              <div className="flex gap-6 flex-wrap">
                <div>
                  <p className="text-lg font-bold text-gray-900">{avgMinutes} phút</p>
                  <p className="text-xs text-gray-400">Trung bình m?i bu?i</p>
                </div>
                <div>
                  <p className="text-lg font-bold text-gray-900">{entries.length > 0 ? Math.round(totalWords / entries.length) : 0} t?</p>
                  <p className="text-xs text-gray-400">Trung bình m?i ngày</p>
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-400">C?m xúc ph? bi?n nh?t</p>
                </div>
              </div>
            </div>
          )}
