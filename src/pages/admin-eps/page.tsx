    ...
    <div className="bg-[#0f1117] border border-[#e8c84a]/20 rounded-2xl p-5 space-y-4">
      ...
      <div className="space-y-3">
        <div>
          ...
          />
          <p className="text-white/20 text-[10px] mt-1">Hỗ trợ: img.hanquocoi.vn, readdy.ai, hoặc bất kỳ URL ảnh nào</p>
        </div>
        <div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-[#0f1117] border border-white/8 rounded-2xl p-5">
        ...
        <p className="text-white/40 text-xs mb-3">Cấu hình Nginx cho img.hanquocoi.vn và audio.hanquocoi.vn</p>
        <div className="relative">
      ...
      <div className="bg-[#e8c84a]/5 border border-[#e8c84a]/20 rounded-xl p-4">
        ...
        <div className="space-y-2 text-white/50 text-xs leading-relaxed">
          <p>1. <strong className="text-white/70">Lần đầu nghe:</strong> App gọi API TTS → nhận file MP3 → lưu vào <code className="text-[#e8c84a]/70">audio.hanquocoi.vn/tts/[từ].mp3</code></p>
          ...
          <p>4. <strong className="text-white/70">SEO:</strong> URL <code className="text-[#e8c84a]/70">audio.hanquocoi.vn</code> giúp Google index âm thanh gắn với domain của bạn</p>
        </div>
      </div>
    </div>
  );
