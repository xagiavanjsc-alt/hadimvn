      ...
      <DashboardLayout>
        <div className="p-6 max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-app-text-secondary text-sm">Ch?n ch? d? và c?p d?, làm bài tr?c nghi?m v?i gi?i thích dáp án chi ti?t</p>
          </div>
          ...
          {/* Question count */}
          <div className="mb-8">
            <p className="text-white/60 text-xs tracking-normal mb-3">S? câu h?i</p>
          ...
          <div className="bg-app-surface/50 border border-app-border rounded-xl p-4 mb-6 flex items-center gap-6">
            <div className="text-center">
              ...
              <p className="text-app-text-secondary text-xs">T? có s?n</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-app-text-secondary text-xs">Câu s? thi</p>
            </div>
            <div className="w-px h-10 bg-white/8"></div>
            <div className="text-center">
          ...
          {filteredWords.length < 4 && (
            <p className="text-red-400 text-xs text-center mt-2">C?n ít nh?t 4 t? d? t?o bài thi. Hãy ch?n ch? d? khác.</p>
          )}
        </div>
      </DashboardLayout>
    );
        ...
        <div className="p-6 max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-app-text-muted text-xs">{correctCount} dúng</p>
              </div>
            </div>
          ...
          <div className="bg-app-surface/50 border border-app-border rounded-2xl p-6 mb-6 text-center">
            <p className="text-app-text-secondary text-xs mb-3 tracking-normal">
              {q.questionType === "ko2vi" ? "T? ti?ng Hàn ? Nghia ti?ng Vi?t" : "Nghia ti?ng Vi?t ? T? ti?ng Hàn"}
            </p>
          ...
          {showExplanation && (
            <div className="bg-app-surface/50 border border-app-border rounded-xl p-4 mb-4">
              <p className="text-white/50 text-xs mb-2 tracking-normal">Ví d? câu</p>
      ...
      <div className="p-6 max-w-3xl mx-auto">
        ...
        <div className="bg-app-surface/50 border border-app-border rounded-2xl p-6 mb-6 text-center">
          ...
          <h2 className="text-xl font-bold text-white mb-1">
            {accuracy >= 80 ? "Xu?t s?c!" : accuracy >= 60 ? "T?t l?m!" : "C?n c? g?ng thêm!"}
          </h2>
          <p className="text-app-text-secondary text-sm mb-4">
            {correctCount}/{results.length} câu dúng · {formatTime(totalTime)}
          </p>
          <div className="flex items-center justify-center gap-6">
            <div className="text-center">
              <p className="text-2xl font-bold text-app-accent-success">{correctCount}</p>
              <p className="text-app-text-muted text-xs">Ðúng</p>
            </div>
            <div className="text-center">
        ...
        <div className="flex gap-2 mb-4">
          {(["all", "correct", "wrong"] as const).map((f) => (
            ...
            >
              {f === "all" ? `T?t c? (${results.length})` : f === "correct" ? `Ðúng (${correctCount})` : `Sai (${results.length - correctCount})`}
            </button>
          ))}
        </div>
        ...
        <div className="flex gap-3">
          ...
          >
            <i className="ri-settings-3-line mr-2"></i>Cài d?t l?i
          </button>
          <button
