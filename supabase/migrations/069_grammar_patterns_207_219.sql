...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'quotation',
  'Là dạng rút gọn của ㄴ/는다고 하다 + -(으)니까. Vì lời nói của bản thân hoặc nội dung nghe từ người khác nên xảy ra tình huống phía sau. Chủ ngữ 2 vế phải khác nhau. Nếu ở dạng đuôi kết, có ý nghĩa nhấn mạnh ý kiến của người nói [đã bảo là... mà]. Dạng nhấn mạnh: (느)ㄴ다니까는 hoặc (느)ㄴ다니까요.',
...
SELECT id, '친구가 그 영화가 재미있___ 주말에 그 영화를 봐야겠어요.', 'fill_blank', '["다니까", "다면서", "다거나", "다든지"]'::jsonb, 0,
  '인용+이유: 친구가 말한 내용이 이유 → 재미있다니까'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다니까' AND topik_level = 'TOPIK IV';

INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '난 이게 좋___ (강조형).', 'fill_blank', '["다니까", "다면서", "다거나", "다든지"]'::jsonb, 0,
  '종결형으로 자신의 의견 강조 → 좋다니까'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다니까' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'quotation',
  'Là dạng rút gọn của (느)ㄴ다고 하면서. Thể hiện việc người khác nói lời nào đó và đồng thời thực hiện hành động. 2 vế phải có cùng chủ ngữ, chủ ngữ chỉ xuất hiện 1 lần ở đầu câu. Có thể dùng dưới dạng rút gọn (느)ㄴ다며.',
  'V + (느)ㄴ다면서 / A + 다면서 / N + (이)라면서 / rút gọn: (느)ㄴ다며',
  '[
    {"korean": "수진 씨가 오늘 회의가 있다면서 회의에 관한 자료를 준비했어요.", "vietnamese": "Sujin nói rằng hôm nay có cuộc họp và cô ấy đã chuẩn bị tài liệu liên quan."},
    ...
    {"korean": "민준 씨는 요즘 건강이 나빠졌다면서 운동을 해야겠다고 하더군요.", "vietnamese": "Min Jun than rằng sức khỏe cậu ấy gần đây xấu đi và cậu ấy phải tập thể dục."},
    {"korean": "사장님께서 판매가 왜 이렇게 저조하냐면서 새로운 전략을 생각해보라고 하셨다.", "vietnamese": "Giám đốc hỏi tại sao doanh số sụt giảm đồng thời bảo hãy nghĩ chiến lược mới."}
  ]'::jsonb,
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '수진 씨가 오늘 회의가 있___ 자료를 준비했어요.', 'fill_blank', '["다면서", "다니까", "다거나", "다든지"]'::jsonb, 0,
  '동시행동+인용, 주어 동일 → 있다면서'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다면서' AND topik_level = 'TOPIK IV';

INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '어떤 남자가 선호 씨를 찾는___ 사무실을 기웃거렸다.', 'fill_blank', '["다면서", "다니까", "다거나", "다손 치더라도"]'::jsonb, 0,
  '말하면서 동시에 행동, 주어 동일 → 찾는다면서'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다면서' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'quotation',
  'Dạng trích dẫn của cấu trúc lựa chọn 거나 – 거나. Liệt kê các lựa chọn ở dạng trích dẫn gián tiếp. Có thể thay thế bằng (느)ㄴ다든가.',
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '몸이 아프___ 도움이 필요하___ 하면 전화하세요.', 'fill_blank', '["다거나 다거나", "다면서 다면서", "다니까 다니까", "다든지 다든지"]'::jsonb, 0,
  '인용 형식으로 선택지 나열 → 아프다거나 필요하다거나'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다거나' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'quotation',
  'Đều là dạng hồi tưởng lại điều đã nghe thấy từ người khác. Cả ba dạng đều có nghĩa tương đương nhưng sắc thái nhẹ khác nhau: 다더군요 (ngạc nhiên khi thông báo), 다던데요 (mở cầu phản hồi), 다더라고요 (kể lại tự nhiên).',
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '그 영화 재미있___.', 'fill_blank', '["다더라", "다니까", "다면서", "다거나"]'::jsonb, 0,
  '들은 것을 회상하여 전달 → 재미있다더라'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다더군요 / 다던데요 / 다더라고요' AND topik_level = 'TOPIK IV';

INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '유미네 집은 식구가 많___.', 'fill_blank', '["다던데", "다니까", "다면서", "다거늘"]'::jsonb, 0,
  '들은 정보 전달, 반응 유도 → 많다던데'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다더군요 / 다던데요 / 다더라고요' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'quotation',
  'Liệt kê lựa chọn ở dạng trích dẫn. Có thể thay thế bằng (느)ㄴ다거나. Hai dạng (느)ㄴ다든가 và (느)ㄴ다든지 có nghĩa tương đương và có thể dùng thay thế nhau.',
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '집에 가겠___ 남아 있겠___ 말을 해야지?', 'fill_blank', '["다든가 다든가", "다거나 다거나", "다면서 다면서", "다니까 다니까"]'::jsonb, 0,
  '인용 형식으로 선택지 열거 → 가겠다든가 있겠다든가'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다든가 / (느)ㄴ다든지' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'quotation',
  'Sau khi nghe điều gì đó từ người khác thì bày tỏ sự ngạc nhiên hoặc không hài lòng về điều đó. Dạng trích dẫn của cấu trúc 이/가 뭐예요? (cái gì mà...).',
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '그 사람이 결혼한___ 뭐예요?', 'fill_blank', '["다지", "다니까", "다면서", "다거나"]'::jsonb, 0,
  '들은 내용에 대한 불만/놀람 표현 → 결혼한다지 뭐예요?'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다지 뭐예요?' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'nominalization',
  'Dùng khi chuyển đổi tính từ hoặc động từ sang dạng danh từ. Chủ yếu sử dụng ở thể văn viết như tin tức, tờ hướng dẫn, quảng cáo, ghi chú — thể hiện văn phong trung tính. Danh từ hóa các mệnh đề đã xảy ra, đã hoàn thành hoặc được quyết định. Một số từ phổ biến: 믿음, 죽음, 웃음, 걸음, 얼음, 꿈, 삶, 기쁨, 슬픔, 느낌, 도움, 모임...',
  'V + (으)ㅁ / A + (으)ㅁ',
  '[
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '내일 수업이 없___ 학생들에게 알려 주세요.', 'fill_blank', '["음을", "기를", "는 것을", "는지를"]'::jsonb, 0,
  '공지/안내문, 사실 명사화 → 없음을'
FROM public.grammar_patterns WHERE pattern = 'A/V – (으)ㅁ' AND topik_level = 'TOPIK IV';

INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '새로 가입하신 여러분을 환영___.', 'fill_blank', '["함", "기", "는 것", "는지"]'::jsonb, 0,
  '공지문 마무리, 간결한 명사형 → 환영함'
FROM public.grammar_patterns WHERE pattern = 'A/V – (으)ㅁ' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'intermediate',
  'purpose',
  'Biểu hiện ý nghĩa: 는 일, 는 것, 는 경우 hay 는 상황. Chủ yếu được sử dụng cùng với: 도움이 되다, 효과가 있다/없다, 좋다/나쁘다, 필요하다, 사용하다, 걸리다, 들다... Có thể dùng dưới dạng 는 데에 hoặc thêm 는 để nhấn mạnh.',
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '건강을 지키는 ___ 담배는 좋지 않아요.', 'fill_blank', '["데에", "기에", "길래", "나머지"]'::jsonb, 0,
  '어떤 일/상황에 관해 → 지키는 데에'
FROM public.grammar_patterns WHERE pattern = 'V – 는 데(에)(는)' AND topik_level = 'TOPIK IV';

INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '이 작품을 완성하는 ___ 10년이나 걸린다고 한다.', 'fill_blank', '["데", "기에", "까닭에", "므로"]'::jsonb, 0,
  '시간이 걸리다 + 는 데 → 완성하는 데'
FROM public.grammar_patterns WHERE pattern = 'V – 는 데(에)(는)' AND topik_level = 'TOPIK IV';
...
INSERT INTO public.grammar_patterns (
  ...
  'advanced',
  'quotation',
  'Mang ý nghĩa 거늘: vốn dĩ nói là vế trước vẫn như vậy, vế sau có sự khác biệt hoặc phản biện. Thể hiện sự ngạc nhiên khi thực tế khác với điều đã được nói. Mang sắc thái văn viết.',
  'V + (느)ㄴ다거늘 / A + 다거늘',
  '[
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '모두들이 괜찮___ 혼자만 싫다고 하네.', 'fill_blank', '["다거늘", "다거나", "다든지", "다면서"]'::jsonb, 0,
  '인용+반전: 모두 말했는데 혼자 반대 → 괜찮다거늘'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다거늘' AND topik_level = 'TOPIK V';
...
INSERT INTO public.grammar_patterns (
  ...
  'advanced',
  'quotation',
  'Dạng trích dẫn của cấu trúc 건만/건마는. Nối lời nói hoặc nhận định ở vế trước với thực tế tương phản ở vế sau. Mang sắc thái văn viết, cổ điển.',
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '그는 부유한 집 아들이었___ 지금 집 한 채도 없어요.', 'fill_blank', '["다건만", "다거늘", "다니까", "다면서"]'::jsonb, 0,
  '인용+역접: 말과 현실의 대조 → 이었다건만'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다건만' AND topik_level = 'TOPIK V';
...
INSERT INTO public.grammar_patterns (
  ...
  'advanced',
  'quotation',
  'Ở dạng câu hỏi, không nói trực tiếp mà diễn đạt một cách tế nhị. Người nói không chắc chắn về từ ngữ phù hợp và muốn xác nhận cách diễn đạt hoặc nói vòng về một điều khó nói thẳng.',
  'V + (느)ㄴ다고나 할까요? / A + 다고나 할까요? / N + (이)라고나 할까요?',
  '[
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '제 성격은 좀 내성적이라___ 할까요?', 'fill_blank', '["고나", "고는", "거나", "건만"]'::jsonb, 0,
  '에둘러 표현: 직접 말하지 않고 돌려 말함 → 이라고나 할까요?'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다고나 할까요?' AND topik_level = 'TOPIK V';
...
INSERT INTO public.grammar_patterns (
  ...
  'advanced',
  'quotation',
  'Nếu ở điều kiện đó thì không còn làm gì được khác. Người nói chấp nhận tình huống do lời nói ở vế trước gây ra, dù có thể không hoàn toàn hài lòng.',
  'V + (느)ㄴ다는데야 / A + 다는데야',
  '[
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '밥을 공짜로 준___ 마다할 이유가 없지.', 'fill_blank', '["다는데야", "다니까", "다거늘", "다건만"]'::jsonb, 0,
  '주어진 조건에 대한 수용: 준다는데야 거부 불가'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다는데야' AND topik_level = 'TOPIK V';

INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '선생님께서 그렇게 하신___ 말릴 방법이 있겠나?', 'fill_blank', '["다는데야", "다니까", "다면서", "다거나"]'::jsonb, 0,
  '어쩔 수 없는 상황 인정 → 하신다는데야'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다는데야' AND topik_level = 'TOPIK V';
...
INSERT INTO public.grammar_patterns (
  ...
  'advanced',
  'quotation',
  'Nhận định lời nói vế trước và điều đó không gây ảnh hưởng đến vế sau. Có thể thay thế bằng 다고 하더라도. Thường đi kèm với 아무리 (dù bao nhiêu, dù thế nào).',
...
INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '아무리 바쁘___ 밥은 먹어야 한다.', 'fill_blank', '["다손 치더라도", "다거늘", "다건만", "다는데야"]'::jsonb, 0,
  '아무리+양보: 아무리 바쁘다손 치더라도 → 결과 변화 없음'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다손 치더라도' AND topik_level = 'TOPIK V';

INSERT INTO public.grammar_practice_questions (pattern_id, question, question_type, options, correct_answer, explanation)
SELECT id, '음식이 맛이 없___ 만든 사람 앞에서 티를 내면 안 되지.', 'fill_blank', '["다손 치더라도", "다거나", "다든지", "다면서"]'::jsonb, 0,
  '양보+인용 → 없다손 치더라도'
FROM public.grammar_patterns WHERE pattern = 'A/V – (느)ㄴ다손 치더라도' AND topik_level = 'TOPIK V';
