...
A/V – 다고 하던데: điều mà người thứ 3 nói [tôi thấy anh chị ấy/người ta nói là...]. Mệnh đề sau diễn tả quan điểm, câu hỏi, lời khuyên hoặc gợi ý.',
  ...
  '[
    ...
    {"korean": "가: 미우 씨가 동아리 신청하려면 학생회관 2층으로 오라고 하던데 학생회관 어디에 있어요? 나: 학교의 식당 건물 맞은편에 있어요.", "vietnamese": "가: Mi Woo nói nếu muốn đăng ký câu lạc bộ thì hãy lên tầng 2 hội trường học sinh. Hội trường học sinh ở đâu vậy? 나: Nó ở đối diện với nhà ăn của trường học."}
  ]'::jsonb,
...
FROM public.grammar_patterns WHERE pattern = 'A/V – 다고 하던데' AND topik_level = 'TOPIK II';
...
Có thể sử dụng dạng (으)ㄹ까 – (으)ㄹ까 하다 để thể hiện phân vân giữa 2 việc. Có thể sử dụng dạng (으)ㄹ까 말까 하다 để thể hiện phân vân làm hay không. Chủ ngữ는 나(저), 우리.',
  ...
  '[
    ...
    {"korean": "가: 텔레비전을 새로 샀다면서요? 어떤 거 샀어요? 나: 아직 안 샀어요. 살까 말까 해요.", "vietnamese": "가: Thấy bảo cậu mua TV mới rồi hả? Cậu mua loại nào thế? 나: Tôi vẫn chưa mua. Tôi đang phân vân nên mua hay không."}
  ]'::jsonb,
...
FROM public.grammar_patterns WHERE pattern = 'V – (으)ㄹ까 하다' AND topik_level = 'TOPIK II';
